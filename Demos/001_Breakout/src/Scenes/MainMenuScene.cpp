...
void MainMenuScene::Tick(f32 dt)
{
...
SceneRequest MainMenuScene::Update(f32 dt, const gk::platform::Extent2D& windowSize)
{
  if(gk::platform::GetInput()->WasKeyPressed(gk::platform::KeyCode::Enter))
  {
    return SceneRequest::SwitchTo(SceneID::Game);
  }
...
void MainMenuScene::Render(gk::graphics::ICommandList* cmd, Renderer& renderer, u32 frameIndex)
{
